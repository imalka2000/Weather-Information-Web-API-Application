...
if (!OWM_API_KEY) {
  console.error('ERROR: Add API KEY in .env');
  process.exit(1);
}
...
// --- New helpers: search and addCity
...
// Add by lat/lon. Validate first by fetching data.
...
// Save cities array back to cities.json
